...
public:
  ...
  {
    pub = this->create_publisher<sensor_msgs::msg::Image>("/xtion/ir/image", 100);
  }
...
int main(int argc, char * argv[])
{
  ...
  auto node = std::make_shared<LifecycleNode>("ir_image_1_to_2");

  // ROS 1 node and subscriber
  ros::init(argc, argv, "ir_image_1_to_2");
  ros::NodeHandle n;
  ros::Subscriber sub = n.subscribe("/xtion/ir/image", 100, TFCallback);
