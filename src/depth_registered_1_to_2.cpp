...
public:
  ...
  {
    pub = this->create_publisher<sensor_msgs::msg::Image>("/xtion/depth_registered/image_raw", 100);
  }
...
int main(int argc, char * argv[])
{
  ...
  auto node = std::make_shared<LifecycleNode>("depth_registered_1_to_2");

  // ROS 1 node and subscriber
  ros::init(argc, argv, "depth_registered_1_to_2");
  ros::NodeHandle n;
  ros::Subscriber sub = n.subscribe("/xtion/depth_registered/image_raw", 100, TFCallback);
