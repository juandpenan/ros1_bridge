...
rclcpp_lifecycle::LifecyclePublisher<sensor_msgs::msg::JointState>::SharedPtr pub;
...
public:
  ...
  {
    pub = this->create_publisher<sensor_msgs::msg::JointState>("/joint_states", 100);
  }
  ...
  friend void TFCallback(boost::shared_ptr<sensor_msgs::JointState> ros1_msg);
};

void TFCallback(boost::shared_ptr<sensor_msgs::JointState> ros1_msg)
{
...
int main(int argc, char * argv[])
{
  ...
  auto node = std::make_shared<LifecycleNode>("js_1_to_2");

  // ROS 1 node and subscriber
  ros::init(argc, argv, "js_1_to_2");
  ros::NodeHandle n;
  ros::Subscriber sub = n.subscribe("/joint_states", 100, TFCallback);
