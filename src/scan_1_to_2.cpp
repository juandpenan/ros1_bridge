...
rclcpp_lifecycle::LifecyclePublisher<sensor_msgs::msg::LaserScan>::SharedPtr pub;
...
public:
  ...
  {
    pub = this->create_publisher<sensor_msgs::msg::LaserScan>("/scan", 100);
  }
  ...
  friend void TFCallback(boost::shared_ptr<sensor_msgs::LaserScan> ros1_msg);
};
...
int main(int argc, char * argv[])
{
  ...
  auto node = std::make_shared<LifecycleNode>("scan_1_to_2");
